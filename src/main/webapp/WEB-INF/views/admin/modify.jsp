...
<form id="blog-form" action="modify" method="post">
    ...
    <div><spring:message code="blog.title" /> : <input type="text" name="title" value="${article.title }" style="width: 70%;"/></div>
    <div><spring:message code="blog.keywords" /> : <input type="text" name="keywords" value="${article.keywords }"style="width: 70%;" /></div>
    <div><spring:message code="blog.description" /> : <input type="text" name="description" value="${article.description }" style="width: 70%;" /></div>
