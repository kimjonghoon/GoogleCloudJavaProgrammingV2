...
<div id="memberMenu" style="float: right;position: relative;top: 7px;" lang="en">
    ...
    <c:choose>
        ...
        <c:otherwise>
            <span style="color: #999;font-family: Verdana, sans-serif;font-weight: bold;font-size: 12px;">Hello, ${nicknameCheck }!</span> 
            <input type="button" value="<spring:message code="user.logout" />" onclick="location.href='/logout'" />
            <input type="button" value="<spring:message code="user.change.nickname" />" onclick="location.href = '/users/changeNickname'" />
        </c:otherwise>
	</c:choose>
</div>
