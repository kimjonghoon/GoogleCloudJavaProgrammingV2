...
public class LecturesController {
	...
	@GetMapping("{category}")
	public String getLatestBlogPost(Model model, Locale locale, @PathVariable String category) {
		...
		return category + "/" + article.getId();

	}
	@GetMapping("{category}/{id}")
	public String getPosts(Model model, Locale locale, @PathVariable String category, @PathVariable String id) {
		String lang = locale.getLanguage();
		Key<Lang> theLang = Key.create(Lang.class, lang);
		Key<Category> theCategory = Key.create(theLang, Category.class, category);
